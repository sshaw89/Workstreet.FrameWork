...
public class InvalidUserLogin extends BaseClass {

	Logger log=Logger.getLogger(InvalidUserLogin.class);
	@Test
	public void invalidLoginTest() throws Throwable {
		...
		login.loginToApp(pobj.getProperty("invalidusername"), pobj.getProperty("password"));
