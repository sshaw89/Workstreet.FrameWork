...
public class InvaliduserandInvalidPassword extends BaseClass{

	
	Logger log=Logger.getLogger(InvaliduserandInvalidPassword.class);
	@Test
	public void invalidusernameInvalidPassword() throws Throwable {
		...
		login.loginToApp(pobj.getProperty("invalidusername"), pobj.getProperty("invalidpassword"));
